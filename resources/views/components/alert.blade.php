...
@php
    switch ($type) {
        ...
        case 'danger':
            ...
            break;
        case 'success':
            $class = 'text-sm text-green-800 bg-green-50 dark:bg-gray-800 dark:text-green-400';
            break;
        case 'warning':
...
@endphp
<div class="p-4 rounded-lg {{$class}}"  {{$attributes->merge(['class' => 'p-4 text-sm rounded-lg' . $class])}} role="alert">
